...
<template> 
  ...
  <!-- <el-row> -->
    <el-page-header :icon="null"class="title">
    <template #content>
  ...
  <div style="display: flex;" > 
        ...
        <el-menu default-active="2" class="el-menu-vertical-demo" @open="handleOpen" @close="handleClose"
          style="width: 200px;height: 100vh;display: flex ;flex-direction: column; margin-left: 0;">
  ...
  <div style="display: flex;flex-direction: column;align-items: stretch;overflow: hidden; line-height: 1em"><router-view></router-view></div>
</div>
